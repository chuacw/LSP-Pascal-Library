...
type
  TSymbolKind = (skFile = 1, skModule, skNamespace, skPackage, skClass,
    skMethod, skProperty, skField, skConstructor, skEnum, skInterface,
    skFunction, skVariable, skConstant, skString, skNumber, skBoolean, skArray,
    skObject, skKey, skNull, skEnumMember, skStruct, skEvent, skOperator,
    skTypeParameter);
  TSymbolKinds = set of TSymbolKind;

  TOnCallHierarchyIncommingEvent = procedure(Sender: TObject;
    const value: TLSPCallHierarchyIncomingCallResponse;
    const errorCode: Integer; const errorMessage: string) of object;
  TOnCallHierarchyOutgoingEvent = procedure(Sender: TObject;
    const value: TLSPCallHierarchyOutgoingCallResponse;
    const errorCode: Integer; const errorMessage: string) of object;
  TOnCodeActionEvent = procedure(Sender: TObject;
    const value: TLSPCodeActionResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnCodeActionResolveEvent = procedure(Sender: TObject;
    const value: TLSPCodeAction; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnCodeLensEvent = procedure(Sender: TObject;
    const value: TLSPCodeLensResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnCodeLensResolveEvent = procedure(Sender: TObject;
    const value: TLSPCodeLens; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnCodeLensRefreshEvent = procedure(Sender: TObject; var errorCode: Integer;
    var errorMessage: string) of object;
  TOnColorPresentationEvent = procedure(Sender: TObject;
    const values: TLSPColorPresentationValues; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnCompletionEvent = procedure(Sender: TObject;
    const list: TLSPCompletionList; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnCompletionItemResolveEvent = procedure(Sender: TObject;
    const item: TLSPCompletionItem; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnConfigurationRequestEvent = procedure(Sender: TObject;
    const values: TLSPConfigurationParams; var AJsonResult: string;
    var errorCode: Integer; var errorMessage: string) of object;
  TOnDocumentColorEvent = procedure(Sender: TObject;
    const values: TLSPColorInformationValues; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnDocumentDiagnosticEvent = procedure(Sender: TObject; const kind: string;
    const resultId: string; const items: TArray<TLSPDiagnostic>;
    const errorCode: Integer; const errorMessage: string;
    const retriggerRequest: Boolean) of object;
  TOnDocumentFormattingEvent = procedure(Sender: TObject;
    const value: TLSPTextEditValues; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnDocumentOnTypeFormattingEvent = procedure(Sender: TObject;
    const value: TLSPTextEditValues; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnDocumentRangeFormattingEvent = procedure(Sender: TObject;
    const value: TLSPTextEditValues; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnDocumentHighlightEvent = procedure(Sender: TObject;
    const value: TLSPDocumentHighlightResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnDocumentLinkEvent = procedure(Sender: TObject;
    const value: TLSPDocumentLinkResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnDocumentLinkResolveEvent = procedure(Sender: TObject;
    const value: TLSPDocumentLink; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnDocumentSymbolsEvent = procedure(Sender: TObject;
    const value: TLSPDocumentSymbolsResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnErrorEvent = procedure(Sender: TObject; const errorCode: Integer;
    const errorMsg: string) of object;
  TOnExecuteCommandRequestEvent = procedure(Sender: TObject; Json: string;
    const errorCode: Integer; const errorMsg: string) of object;
  TOnExitEvent = procedure(Sender: TObject; exitCode: Integer;
    const bRestartServer: Boolean) of object;
  TOnFindReferencesEvent = procedure(Sender: TObject;
    const value: TLSPFindReferencesResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnFoldingRangeEvent = procedure(Sender: TObject;
    const value: TLSPFoldingRangeResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnGotoDeclarationEvent = procedure(Sender: TObject;
    const value: TLSPGotoResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnGotoDefinitionEvent = procedure(Sender: TObject;
    const value: TLSPGotoResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnGotoTypeDefinitionEvent = procedure(Sender: TObject;
    const value: TLSPGotoResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnGotoImplementationEvent = procedure(Sender: TObject;
    const value: TLSPGotoResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnHoverEvent = procedure(Sender: TObject; const value: TLSPHover;
    const errorCode: Integer; const errorMessage: string) of object;
  TOnInitializeEvent = procedure(Sender: TObject;
    var value: TLSPInitializeParams) of object;
  TOnInitializedEvent = procedure(Sender: TObject;
    var value: TLSPInitializeResultParams) of object;
  TOnLinkedEditingRangeEvent = procedure(Sender: TObject;
    const values: TLSPLinkedEditingRanges; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnLogTraceEvent = procedure(Sender: TObject; const value: TLSPLogTraceParams)
    of object;
  TOnMonikerEvent = procedure(Sender: TObject; const values: TLSPMonikerResult;
    const errorCode: Integer; const errorMessage: string) of object;
  TOnPrepareCallHierarchyEvent = procedure(Sender: TObject;
    const value: TLSPPrepareCallHierarchyResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnPrepareTypeHierarchyEvent = procedure(Sender: TObject;
    const value: TLSPPrepareTypeHierarchyResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnPrepareRenameEvent = procedure(Sender: TObject;
    const value: TLSPPrepareRenameResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnPublishDiagnostics = procedure(Sender: TObject; const uri: string;
    const version: Cardinal; const Diagnostics: TArray<TLSPDiagnostic>)
    of object;
  TOnProgressEvent = procedure(Sender: TObject; const id: TLSPKind;
    const value: TLSPBaseParams) of object;
  TOnRegisterCapabilityEvent = procedure(Sender: TObject;
    const values: TLSPRegistrations; var errorCode: Integer;
    var errorMessage: string) of object;
  TOnRenameEvent = procedure(Sender: TObject; const value: TLSPWorkspaceEdit;
    const errorCode: Integer; const errorMessage: string) of object;
  TOnSelectionRangeEvent = procedure(Sender: TObject;
    const value: TLSPSelectionRangeResponse; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnSemanticTokensFullEvent = procedure(Sender: TObject;
    const value: TLSPSemanticTokens; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnSemanticTokensFullDeltaEvent = procedure(Sender: TObject;
    const value: TLSPSemanticTokensDelta; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnSemanticTokensRangeEvent = procedure(Sender: TObject;
    const value: TLSPSemanticTokens; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnSemanticTokensRefreshEvent = procedure(Sender: TObject;
    const errorCode: Integer; const errorMessage: string) of object;
  TOnSignatureHelpEvent = procedure(Sender: TObject;
    const value: TLSPSignatureHelp; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnShowDocumentRequestEvent = procedure(Sender: TObject; const uri: string;
    const bExternal: Boolean; const bTakeFocus: Boolean;
    const startPos, endPos: TLSPPosition; var bSuccess: Boolean) of object;
  TOnShowMessageEvent = procedure(Sender: TObject; const ntype: TLSPMessageType;
    const msg: string) of object;
  TOnShowMessageRequestEvent = procedure(Sender: TObject;
    const ntype: TLSPMessageType; const msg: string;
    const sActionValues: TArray<string>; var sAction: string) of object;
  TOnShutdownEvent = procedure(Sender: TObject; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnTelemetryEvent = procedure(Sender: TObject; Json: string) of object;
  TOnInlayHintEvent = procedure(Sender: TObject;
    const values: TLSPInlayHintResult; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnInlayHintResolveEvent = procedure(Sender: TObject;
    const value: TLSPInlayHint; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnInlayHintRefreshEvent = procedure(Sender: TObject;
    const errorCode: Integer; const errorMessage: string) of object;
  TOnInlineValueEvent = procedure(Sender: TObject;
    const values: TLSPInlineValueResult; const errorCode: Integer;
    const errorMessage: string) of object;
  TOnInlineValueRefreshEvent = procedure(Sender: TObject;
    const errorCode: Integer; const errorMessage: string) of object;
  TOnUnegisterCapabilityEvent = procedure(Sender: TObject;
    const values: TLSPUnregistrations; var errorCode: Integer;
    var errorMessage: string) of object;
  TOnWillSaveWaitUntilTextDocumentResponse = procedure(Sender: TObject;
    const values: TArray<TLSPTextEdit>) of object;
  TOnWorkDoneProgressEvent = procedure(Sender: TObject; const token: string;
    var errorCode: Integer; var errorMessage: string) of object;
  TOnWorkspaceApplyEditRequestEvent = procedure(Sender: TObject;
    const value: TLSPApplyWorkspaceEditParams;
    var responseValue: TLSPApplyWorkspaceEditResponse; var errorCode: Integer;
    var errorMessage: string) of object;
  TOnWorkspaceDiagnosticEvent = procedure(Sender: TObject;
    const items: TArray<TLSPWorkspaceDocumentDiagnosticReport>;
    const errorCode: Integer; const errorMessage: string;
    const retriggerRequest: Boolean) of object;
  TOnWorkspaceDiagnosticRefreshEvent = procedure(Sender: TObject;
    const errorCode: Integer; const errorMessage: string) of object;
  TOnWorkspaceFoldersRequestEvent = procedure(Sender: TObject;
    var values: TLSPWorkspaceFolders; var bSingleFileOpen: Boolean;
    var bNoWorkspaceFolders: Boolean; var errorCode: Integer;
    var errorMessage: string) of object;
  TOnWorkspaceSymbolRequestEvent = procedure(Sender: TObject;
    const symbols: TLSPSymbolInformations) of object;
  TOnWorkspaceWillCreateFilesResponseEvent = procedure(Sender: TObject;
    const value: TLSPWorkspaceEdit) of object;
  TOnWorkspaceWillDeleteFilesResponseEvent = procedure(Sender: TObject;
    const value: TLSPWorkspaceEdit) of object;
  TOnWorkspaceWillRenameFilesResponseEvent = procedure(Sender: TObject;
    const value: TLSPWorkspaceEdit) of object;
  ...
  private
    ...
    procedure SendResponse(const id: Integer; const method: string = '';
      const params: TLSPBaseParams = nil; const errors: TLSPBaseParams = nil;
      resultType: TLSPResultType = lsprObject; resultString: string = '');
  ...
  public
    ...
    function FindDynamicCapability(const method: string)
      : TLSPTextDocumentRegistrationOptions;
    function GetErrorCodeAsString(typ: Integer): string;
    function GetIdFromPartialResultToken(const LStr: string): Integer;
    procedure OnReadFromServer(Sender: TObject; const AJson: ISuperObject;
    ...
    procedure RegisterPartialResultToken(const lspKind: TLSPKind;
      const token: string);
    procedure RunServer(const ACommandline, ADir: String;
      const AEnvList: string = ''; const AHost: string = '';
      const APort: Integer = 0; const AUseSocket: Boolean = False);
    function GetRunTimeInSeconds: Double;
    function GetSyncKind: Integer;
    function IncludeText(const lspKind: TLSPKind; const filename: string;
      const includeDefault: Boolean): Boolean;
    function IsRequestSupported(const lspKind: TLSPKind;
    ...
    procedure SendExecuteCommandRequest(const command: string;
      const argumentsJSON: string = '');
    procedure SendProgressNotification(token: string;
      const value: TLSPWorkDoneProgressValue);
    procedure SendRequest(const lspKind: TLSPKind; const method: string = '';
    ...
    property ServerCapabilities: TLSPServerCapabilities read FServerCapabilities
      write FServerCapabilities;
    property ServerName: string read FServerName write FServerName;
    property ServerVersion: string read FServerVersion write FServerVersion;
    property FOnTypeHierarchySupertypes: TOnPrepareTypeHierarchyEvent
      read FFOnTypeHierarchySupertypes write FFOnTypeHierarchySupertypes;
    property FOnWorkspaceDiagnostic: TOnWorkspaceDiagnosticEvent
      read FFOnWorkspaceDiagnostic write FFOnWorkspaceDiagnostic;
    property OnDocumentDiagnostic: TOnDocumentDiagnosticEvent
      read FOnDocumentDiagnostic write FOnDocumentDiagnostic;
    property OnInlayHint: TOnInlayHintEvent read FOnInlayHint
      write FOnInlayHint;
    ...
    property OnInlineValue: TOnInlineValueEvent read FOnInlineValue
      write FOnInlineValue;
  ...
  published
    ...
    property CloseTimeout: Integer read FCloseTimeout write SetCloseTimeout
      default 3000;
    property ExitTimeout: Integer read FExitTimeout write SetExitTimeout
      default 1000;
    property LogCommunication: Boolean read FLogCommunication
      write FLogCommunication default False;
    property LogFileName: string read FLogFileName write FLogFileName;
    property LogServerMessages: Boolean read FLogServerMessages
      write FLogServerMessages default False;
    ...
    property ResponseTimeout: Integer read FResponseTimeout
      write SetResponseTimeout default 15000;
    property StartTimeout: Integer read FStartTimeout write SetStartTimeout
      default 15000;
    property OnCallHierarchyIncomming: TOnCallHierarchyIncommingEvent
      read FOnCallHierarchyIncomming write FOnCallHierarchyIncomming;
    property OnCallHierarchyOutgoing: TOnCallHierarchyOutgoingEvent
      read FOnCallHierarchyOutgoing write FOnCallHierarchyOutgoing;
    property OnCodeAction: TOnCodeActionEvent read FOnCodeAction
      write FOnCodeAction;
    property OnCodeActionResolve: TOnCodeActionResolveEvent
      read FOnCodeActionResolve write FOnCodeActionResolve;
    property OnCodeLens: TOnCodeLensEvent read FOnCodeLens write FOnCodeLens;
    property OnCodeLensRefresh: TOnCodeLensRefreshEvent read FOnCodeLensRefresh
      write FOnCodeLensRefresh;
    property OnCodeLensResolve: TOnCodeLensResolveEvent read FOnCodeLensResolve
      write FOnCodeLensResolve;
    property OnColorPresentation: TOnColorPresentationEvent
      read FOnColorPresentation write FOnColorPresentation;
    property OnCompletion: TOnCompletionEvent read FOnCompletion
      write FOnCompletion;
    property OnCompletionItemResolve: TOnCompletionItemResolveEvent
      read FOnCompletionItemResolve write FOnCompletionItemResolve;
    property OnConfiguration: TOnConfigurationRequestEvent read FOnConfiguration
      write FOnConfiguration;
    property OnDocumentColor: TOnDocumentColorEvent read FOnDocumentColor
      write FOnDocumentColor;
    property OnDocumentFormatting: TOnDocumentFormattingEvent
      read FOnDocumentFormatting write FOnDocumentFormatting;
    property OnDocumentHighlight: TOnDocumentHighlightEvent
      read FOnDocumentHighlight write FOnDocumentHighlight;
    property OnDocumentLink: TOnDocumentLinkEvent read FOnDocumentLink
      write FOnDocumentLink;
    property OnDocumentLinkResolve: TOnDocumentLinkResolveEvent
      read FOnDocumentLinkResolve write FOnDocumentLinkResolve;
    property OnDocumentOnTypeFormatting: TOnDocumentOnTypeFormattingEvent
      read FOnDocumentOnTypeFormatting write FOnDocumentOnTypeFormatting;
    property OnDocumentRangeFormatting: TOnDocumentRangeFormattingEvent
      read FOnDocumentRangeFormatting write FOnDocumentRangeFormatting;
    property OnDocumentSymbols: TOnDocumentSymbolsEvent read FOnDocumentSymbols
      write FOnDocumentSymbols;
    property OnError: TOnErrorEvent read FOnError write FOnError;
    property OnExit: TOnExitEvent read FOnExit write FOnExit;
    property OnFoldingRange: TOnFoldingRangeEvent read FOnFoldingRange
      write FOnFoldingRange;
    property OnGotoDeclaration: TOnGotoDeclarationEvent read FOnGotoDeclaration
      write FOnGotoDeclaration;
    property OnGotoDefinition: TOnGotoDefinitionEvent read FOnGotoDefinition
      write FOnGotoDefinition;
    property OnGotoTypeDefinition: TOnGotoTypeDefinitionEvent
      read FOnGotoTypeDefinition write FOnGotoTypeDefinition;
    property OnHover: TOnHoverEvent read FOnHover write FOnHover;
    property OnGotoImplementation: TOnGotoImplementationEvent
      read FOnGotoImplementation write FOnGotoImplementation;
    property OnInitialize: TOnInitializeEvent read FOnInitialize
      write FOnInitialize;
    property OnInitialized: TOnInitializedEvent read FOnInitialized
      write FOnInitialized;
    property OnLinkedEditingRange: TOnLinkedEditingRangeEvent
      read FOnLinkedEditingRange write FOnLinkedEditingRange;
    property OnLogMessage: TOnShowMessageEvent read FOnLogMessage
      write FOnLogMessage;
    ...
    property OnPrepareCallHierarchy: TOnPrepareCallHierarchyEvent
      read FOnPrepareCallHierarchy write FOnPrepareCallHierarchy;
    property OnPrepareRename: TOnPrepareRenameEvent read FOnPrepareRename
      write FOnPrepareRename;
    property OnProgress: TOnProgressEvent read FOnProgress write FOnProgress;
    property OnPublishDiagnostics: TOnPublishDiagnostics
      read FOnPublishDiagnostics write FOnPublishDiagnostics;
    property OnRename: TOnRenameEvent read FOnRename write FOnRename;
    property OnSelectionRange: TOnSelectionRangeEvent read FOnSelectionRange
      write FOnSelectionRange;
    property OnSemanticTokensFull: TOnSemanticTokensFullEvent
      read FOnSemanticTokensFull write FOnSemanticTokensFull;
    property OnSemanticTokensFullDelta: TOnSemanticTokensFullDeltaEvent
      read FOnSemanticTokensFullDelta write FOnSemanticTokensFullDelta;
    property OnSemanticTokensRange: TOnSemanticTokensRangeEvent
      read FOnSemanticTokensRange write FOnSemanticTokensRange;
    property OnSemanticTokensRefresh: TOnSemanticTokensRefreshEvent
      read FOnSemanticTokensRefresh write FOnSemanticTokensRefresh;
    property OnShowDocument: TOnShowDocumentRequestEvent read FOnShowDocument
      write FOnShowDocument;
    property OnShowMessage: TOnShowMessageEvent read FOnShowMessage
      write FOnShowMessage;
    property OnShowMessageRequest: TOnShowMessageRequestEvent
      read FOnShowMessageRequest write FOnShowMessageRequest;
    property OnShutdown: TOnShutdownEvent read FOnShutdown write FOnShutdown;
    property OnSignatureHelp: TOnSignatureHelpEvent read FOnSignatureHelp
      write FOnSignatureHelp;
    property OnTelemetryEvent: TOnTelemetryEvent read FOnTelemetryEvent
      write FOnTelemetryEvent;
    property OnUnregisterCapability: TOnUnegisterCapabilityEvent
      read FOnUnregisterCapability write FOnUnregisterCapability;
    property OnWillSaveWaitUntilTextDocument
      : TOnWillSaveWaitUntilTextDocumentResponse
      read FOnWillSaveWaitUntilTextDocument
      write FOnWillSaveWaitUntilTextDocument;
    property OnWorkDoneProgress: TOnWorkDoneProgressEvent
      read FOnWorkDoneProgress write FOnWorkDoneProgress;
    property OnWorkspaceApplyEdit: TOnWorkspaceApplyEditRequestEvent
      read FOnWorkspaceApplyEdit write FOnWorkspaceApplyEdit;
    property OnWorkspaceFolders: TOnWorkspaceFoldersRequestEvent
      read FOnWorkspaceFolders write FOnWorkspaceFolders;
    property OnWorkspaceSymbol: TOnWorkspaceSymbolRequestEvent
      read FOnWorkspaceSymbol write FOnWorkspaceSymbol;
    property OnWorkspaceWillCreateFiles
      : TOnWorkspaceWillCreateFilesResponseEvent
      read FOnWorkspaceWillCreateFiles write FOnWorkspaceWillCreateFiles;
    property OnWorkspaceWillDeleteFiles
      : TOnWorkspaceWillDeleteFilesResponseEvent
      read FOnWorkspaceWillDeleteFiles write FOnWorkspaceWillDeleteFiles;
    property OnWorkspaceWillRenameFiles
      : TOnWorkspaceWillRenameFilesResponseEvent
      read FOnWorkspaceWillRenameFiles write FOnWorkspaceWillRenameFiles;
    property OnExecuteCommand: TOnExecuteCommandRequestEvent
      read FOnExecuteCommandRequest write FOnExecuteCommandRequest;
    property OnFindReferences: TOnFindReferencesEvent read FOnFindReferences
      write FOnFindReferences;
  end;
...
begin
  ...
  begin
    ...
    begin
      Result := TLSPTextDocumentRegistrationOptions
        (FDynamicCapabilities.Objects[i]);
    end;
  end;
end;
...
begin
  ws := UTF8Encode(s);
  w := 'Content-Length: ' + IntToStr(Length(ws)) + Char(13) + Char(10) +
    Char(13) + Char(10);
  ws := UTF8Encode(w) + ws;
...
begin
  ...
  case typ of
    - 32700:
      Result := 'ParseError: (-32700)';
    -32600:
      Result := 'InvalidRequest: (-32600)';
    -32601:
      Result := 'MethodNotFound: (-32601)';
    -32602:
      Result := 'InvalidParams: (-32602)';
    -32603:
      Result := 'InternalError: (-32603)';
    -32099:
      Result := 'jsonrpcReservedErrorRangeStart: (-32099)';
    -32002:
      Result := 'ServerNotInitialized (-32002)';
    -32001:
      Result := 'UnknownErrorCode: (-32001)';
    -32000:
      Result := 'jsonrpcReservedErrorRangeEnd: (-32000)';
    -32899:
      Result := 'lspReservedErrorRangeStart: (-32899)';
    -32801:
      Result := 'ContentModified: (-32801)';
    -32800:
      Result := 'RequestCancelled: (-32800)';
  end;
end;
...
begin
  ...
  if n >= 0 then
    Result := StrToInt(FPartialTokens.ValueFromIndex[n]);
end;
...
begin
  ...
  if id < 0 then
  begin
    if (LJson['error'].DataType = dtObject) and
      (LJson['error.code'].AsInteger < 0) then
      id := Ord(lspError)
    else
  ...
  case TLSPKind(LKind) of
    ...
    lspInitialize:
      begin
        ...
        FInitializeResultObject := JsonInitializeResultToObject(LJson,
      ...
      begin
        ...
        begin
          case TLSPMessageType(LInt) of
            TLSPMessageType.lspMsgError:
              ws := 'Error: ' + LStr + #13#10;
            TLSPMessageType.lspMsgWarning:
              ws := 'Warning: ' + LStr + #13#10;
            TLSPMessageType.lspMsgInfo:
              ws := 'Info: ' + LStr + #13#10;
            TLSPMessageType.lspMsgLog:
              ws := 'Log: ' + LStr + #13#10;
          end;
          SaveToLogFile(ws);
        end;
    ...
    lspProgress:
      begin
        ...
        case TLSPKind(LKind) of
          lspWorkspaceSymbol:
            begin
              if Length(TLSPWorkspaceSymbolInformationParam(params).values) = 0
              then
                UnRegisterPartialResultToken(LStr);
            end;
          lspCallHierarchyIncommingCalls:
            begin
              if Length(TLSPCallHierarchyIncomingCallResponse(params).items) = 0
              then
                UnRegisterPartialResultToken(LStr);
            end;
          lspCallHierarchyOutgoingCalls:
            begin
              if Length(TLSPCallHierarchyOutgoingCallResponse(params).items) = 0
              then
                UnRegisterPartialResultToken(LStr);
            end;
          lspColorPresentation:
            begin
              if Length(TLSPColorPresentationValues(params)
                .colorPresentations) = 0 then
                UnRegisterPartialResultToken(LStr);
            end;
          lspDocumentColor:
            begin
          ...
          lspDocumentSymbol:
            begin
              if (Length(TLSPDocumentSymbolsResponse(params).symbols) = 0) and
                (Length(TLSPDocumentSymbolsResponse(params)
                .symbolInformations) = 0) then
                UnRegisterPartialResultToken(LStr);
            end;
          lspFoldingRange:
            begin
              if not Assigned(params) or
                (Length(TLSPFoldingRangeResponse(params).foldingRanges) = 0)
              then
                UnRegisterPartialResultToken(LStr);
            end;
          lspMoniker:
            begin
              if not Assigned(params) or
                (Length(TLSPMonikerResult(params).monikers) = 0) then
                UnRegisterPartialResultToken(LStr);
            end;
          lspInlayHint:
            begin
              if not Assigned(params) or
                (Length(TLSPInlayHintResult(params).inlayHints) = 0) then
                UnRegisterPartialResultToken(LStr);
            end;
          lspSelectionRange:
            begin
          ...
          lspSemanticTokensFull:
            begin
              if not Assigned(params) or
                (Length(TLSPSemanticTokens(params).data) = 0) then
                UnRegisterPartialResultToken(LStr);
            end;
          lspSemanticTokensFullDelta:
            begin
              if not Assigned(params) or
                (Length(TLSPSemanticTokensDelta(params).edits) = 0) then
                UnRegisterPartialResultToken(LStr);
            end;
    ...
    lspCallHierarchyIncommingCalls:
      begin
        params := JsonCallHierarchyIncommingResponseToObject(LJson, errorCode,
          errorMessage);

        // OnCallHierarchyIncomming event
        if Assigned(FOnCallHierarchyIncomming) then
          FOnCallHierarchyIncomming(Self,
            TLSPCallHierarchyIncomingCallResponse(params), errorCode,
            errorMessage);
    ...
    lspCallHierarchyOutgoingCalls:
      begin
        params := JsonCallHierarchyOutgoingResponseToObject(LJson, errorCode,
          errorMessage);

        // OnCallHierarchyOutgoing event
        if Assigned(FOnCallHierarchyOutgoing) then
          FOnCallHierarchyOutgoing(Self,
            TLSPCallHierarchyOutgoingCallResponse(params), errorCode,
            errorMessage);
    ...
    lspCodeAction:
      begin
        params := JsonCodeActionResponseToObject(LJson, errorCode,
          errorMessage);

        // OnCodeAction event
        if Assigned(FOnCodeAction) then
          FOnCodeAction(Self, TLSPCodeActionResponse(params), errorCode,
            errorMessage);
    ...
    lspCodeActionResolve:
      begin
        ...
        if Assigned(FOnCodeActionResolve) then
          FOnCodeActionResolve(Self, TLSPCodeAction(params), errorCode,
            errorMessage);
    ...
    lspCodeLens:
      begin
        ...
        if Assigned(FOnCodeLens) then
          FOnCodeLens(Self, TLSPCodeLensResponse(params), errorCode,
            errorMessage);
    ...
    lspCodeLensResolve:
      begin
        ...
        if Assigned(FOnCodeLensResolve) then
          FOnCodeLensResolve(Self, TLSPCodeLens(params), errorCode,
            errorMessage);
    ...
    lspColorPresentation:
      begin
        params := JsonColorPresentationValuesToObject(LJson, errorCode,
          errorMessage);

        // OnColorPresentation event
        if Assigned(FOnColorPresentation) then
          FOnColorPresentation(Self, TLSPColorPresentationValues(params),
            errorCode, errorMessage);
    ...
    lspCompletion:
      begin
        params := JsonCompletionResponseToObject(LJson, errorCode,
          errorMessage);

        // OnCompletion event
        if Assigned(FOnCompletion) then
          FOnCompletion(Self, TLSPCompletionList(params), errorCode,
            errorMessage);
    ...
    lspCompletionItemResolve:
      begin
        params := JsonCompletionItemResolveToObject(LJson, errorCode,
          errorMessage);

        // OnCompletionItemResolve event
        if Assigned(FOnCompletionItemResolve) then
          FOnCompletionItemResolve(Self, TLSPCompletionItem(params), errorCode,
            errorMessage);
    ...
    lspDocumentColor:
      begin
        params := JsonDocumentColorValuesToObject(LJson, errorCode,
          errorMessage);

        // OnDocumentColor event
        if Assigned(FOnDocumentColor) then
          FOnDocumentColor(Self, TLSPColorInformationValues(params), errorCode,
            errorMessage);
    ...
    lspDocumentFormatting:
      begin
        params := JsonDocumentFormattingResponseToObject(LJson, errorCode,
          errorMessage);

        // OnDocumentFormatting event
        if Assigned(FOnDocumentFormatting) then
          FOnDocumentFormatting(Self, TLSPTextEditValues(params), errorCode,
            errorMessage);
    ...
    lspDocumentRangeFormatting:
      begin
        ...
        if Assigned(FOnDocumentRangeFormatting) then
          FOnDocumentRangeFormatting(Self, TLSPTextEditValues(params),
            errorCode, errorMessage);
    ...
    lspDocumentOnTypeFormatting:
      begin
        ...
        if Assigned(FOnDocumentOnTypeFormatting) then
          FOnDocumentOnTypeFormatting(Self, TLSPTextEditValues(params),
            errorCode, errorMessage);
    ...
    lspDocumentHighlight:
      begin
        params := JsonDocumentHighlightResponseToObject(LJson, errorCode,
          errorMessage);

        // OnDocumentHighlight event
        if Assigned(FOnDocumentHighlight) then
          FOnDocumentHighlight(Self, TLSPDocumentHighlightResponse(params),
            errorCode, errorMessage);
    ...
    lspDocumentLink:
      begin
        params := JsonDocumentLinkResponseToObject(LJson, errorCode,
          errorMessage);

        // OnDocumentLink event
        if Assigned(FOnDocumentLink) then
          FOnDocumentLink(Self, TLSPDocumentLinkResponse(params), errorCode,
            errorMessage);
    ...
    lspDocumentLinkResolve:
      begin
        params := JsonDocumentLinkResolveToObject(LJson, errorCode,
          errorMessage);

        // OnDocumentLinkResolve event
        if Assigned(FOnDocumentLinkResolve) then
          FOnDocumentLinkResolve(Self, TLSPDocumentLink(params), errorCode,
            errorMessage);
    ...
    lspDocumentSymbol:
      begin
        params := JsonDocumentSymbolsResponseToObject(LJson, errorCode,
          errorMessage);

        // OnDocumentSymbols event
        if Assigned(FOnDocumentSymbols) then
          FOnDocumentSymbols(Self, TLSPDocumentSymbolsResponse(params),
            errorCode, errorMessage);
    ...
    lspFoldingRange:
      begin
        params := JsonFoldingRangeResponseToObject(LJson, errorCode,
          errorMessage);

        // OnFoldingRange event
        if Assigned(FOnFoldingRange) then
          FOnFoldingRange(Self, TLSPFoldingRangeResponse(params), errorCode,
            errorMessage);
    ...
    lspGotoDeclaration:
      begin
        ...
        if Assigned(FOnGotoDeclaration) then
          FOnGotoDeclaration(Self, TLSPGotoResponse(params), errorCode,
            errorMessage);
    ...
    lspGotoDefinition:
      begin
        ...
        if Assigned(FOnGotoDefinition) then
          FOnGotoDefinition(Self, TLSPGotoResponse(params), errorCode,
            errorMessage);
    ...
    lspGotoImplementation:
      begin
        ...
        if Assigned(FOnGotoImplementation) then
          FOnGotoImplementation(Self, TLSPGotoResponse(params), errorCode,
            errorMessage);
    ...
    lspGotoTypeDefinition:
      begin
        ...
        if Assigned(FOnGotoTypeDefinition) then
          FOnGotoTypeDefinition(Self, TLSPGotoResponse(params), errorCode,
            errorMessage);
    ...
    lspLinkedEditingRange:
      begin
        params := JsonLinkedEditingRangesToObject(LJson, errorCode,
          errorMessage);

        // OnLinkedEditingRange event
        if Assigned(FOnLinkedEditingRange) then
          FOnLinkedEditingRange(Self, TLSPLinkedEditingRanges(params),
            errorCode, errorMessage);
    ...
    lspInlayHint:
      begin
        ...
        if Assigned(FOnInlayHint) then
          FOnInlayHint(Self, TLSPInlayHintResult(params), errorCode,
            errorMessage);
    ...
    lspInlayHintResolve:
      begin
        ...
        if Assigned(FOnInlayHintResolve) then
          FOnInlayHintResolve(Self, TLSPInlayHint(params), errorCode,
            errorMessage);
    ...
    lspInlineValue:
      begin
        params := JsonInlineValueResponseToObject(LJson, errorCode,
          errorMessage);

        // OnInlineValue event
        if Assigned(FOnInlineValue) then
          FOnInlineValue(Self, TLSPInlineValueResult(params), errorCode,
            errorMessage);
    ...
    lspDocumentDiagnostic:
      begin
        params := JsonDocumentDiagnosticReportToObject(LJson, errorCode,
          errorMessage, retriggerRequest);

        // OnDocumentDiagnostic event
        if Assigned(FOnDocumentDiagnostic) then
          FOnDocumentDiagnostic(Self, TLSPDocumentDiagnosticReport(params).kind,
            TLSPDocumentDiagnosticReport(params).resultId,
            TLSPDocumentDiagnosticReport(params).items, errorCode, errorMessage,
            retriggerRequest);
      end;
    ...
    lspWorkspaceDiagnostic:
      begin
        params := JsonWorkspaceDiagnosticReportToObject(LJson, errorCode,
          errorMessage, retriggerRequest);

        // OnWorkspaceDiagnostic event
        if Assigned(FOnWorkspaceDiagnostic) then
          FOnWorkspaceDiagnostic(Self, TLSPWorkspaceDiagnosticReport(params)
            .items, errorCode, errorMessage, retriggerRequest);
      end;
    ...
    lspPublishDiagnostics:
      begin
        ...
        if Assigned(FOnPublishDiagnostics) then
          FOnPublishDiagnostics(Self, TLSPPublishDiagnosticsParams(params).uri,
    ...
    lspPrepareCallHierarchy:
      begin
        params := JsonPrepareCallHierarchyResponseToObject(LJson, errorCode,
          errorMessage);

        // OnPrepareCallHierarchy event
        if Assigned(FOnPrepareCallHierarchy) then
          FOnPrepareCallHierarchy(Self,
            TLSPPrepareCallHierarchyResponse(params), errorCode, errorMessage);
    ...
    lspPrepareTypeHierarchy:
      begin
        params := JsonPrepareTypeHierarchyResponseToObject(LJson, errorCode,
          errorMessage);

        // OnPrepareTypeHierarchy event
        if Assigned(FOnPrepareTypeHierarchy) then
          FOnPrepareTypeHierarchy(Self,
            TLSPPrepareTypeHierarchyResponse(params), errorCode, errorMessage);
    ...
    lspTypeHierarchySupertypes:
      begin
        params := JsonTypeHierarchySupertypesResponseToObject(LJson, errorCode,
          errorMessage);

        // OnTypeHierarchySupertypes event
        if Assigned(FOnTypeHierarchySupertypes) then
          FOnTypeHierarchySupertypes(Self,
            TLSPPrepareTypeHierarchyResponse(params), errorCode, errorMessage);
    ...
    lspPrepareRename:
      begin
        params := JsonPrepareRenameResponseToObject(LJson, errorCode,
          errorMessage);

        // OnPrepareRename event
        if Assigned(FOnPrepareRename) then
          FOnPrepareRename(Self, TLSPPrepareRenameResponse(params), errorCode,
            errorMessage);
    ...
    lspReferences:
      begin
        params := JsonFindReferencesResponseToObject(LJson, errorCode,
          errorMessage);

        // OnFindReferences event
        if Assigned(FOnFindReferences) then
          FOnFindReferences(Self, TLSPFindReferencesResponse(params), errorCode,
            errorMessage);
    ...
    lspSelectionRange:
      begin
        params := JsonSelectionRangeResponseToObject(LJson, errorCode,
          errorMessage);

        // OnSelectionRange event
        if Assigned(FOnSelectionRange) then
          FOnSelectionRange(Self, TLSPSelectionRangeResponse(params), errorCode,
            errorMessage);
    ...
    lspSemanticTokensFull:
      begin
        params := JsonSemanticTokensFullToObject(LJson, errorCode,
          errorMessage);

        // OnSemanticTokensFull event
        if Assigned(FOnSemanticTokensFull) then
          FOnSemanticTokensFull(Self, TLSPSemanticTokens(params), errorCode,
            errorMessage);
    ...
    lspSemanticTokensFullDelta:
      begin
        params := JsonSemanticTokensFullDeltaToObject(LJson, errorCode,
          errorMessage);

        // OnSemanticTokensFullDelta event
        if Assigned(FOnSemanticTokensFullDelta) then
          FOnSemanticTokensFullDelta(Self, TLSPSemanticTokensDelta(params),
            errorCode, errorMessage);
    ...
    lspSemanticTokensRange:
      begin
        ...
        if Assigned(FOnSemanticTokensRange) then
          FOnSemanticTokensRange(Self, TLSPSemanticTokens(params), errorCode,
            errorMessage);
    ...
    lspShowDocumentRequest:
      begin
        ...
        if Assigned(FOnShowDocument) then
          FOnShowDocument(Self, TLSPShowDocumentParams(params).uri,
            ...
            TLSPShowDocumentParams(params).selection.endPos, bValue);
    ...
    lspShowMessageRequest:
      begin
        ...
        if Assigned(FOnShowMessageRequest) then
          FOnShowMessageRequest(Self, TLSPMessageType(LInt), LStr,
            LStrArray, LValue);
    ...
    lspSignatureHelp:
      begin
        params := JsonSignatureHelpResponseToObject(LJson, errorCode,
          errorMessage);

        // OnSignatureHelp event
        if Assigned(FOnSignatureHelp) then
          FOnSignatureHelp(Self, TLSPSignatureHelp(params), errorCode,
            errorMessage);
    ...
    lspClientUnRegisterCapabilities:
      begin
        ...
        if Assigned(FOnUnregisterCapability) then
          FOnUnregisterCapability(Self, LUnregistrations, errorCode,
            errorMessage);
    ...
    lspWorkspaceApplyEdit:
      begin
        errorCode := 0;
        errorMessage := '';
        params := JsonWorkspaceApplyEditParamsToObject(LJson, '', errorCode,
          errorMessage);
        rparams := TLSPApplyWorkspaceEditResponse.Create;

        // OnWorkspaceApplyEdit event
        if Assigned(FOnWorkspaceApplyEdit) then
          FOnWorkspaceApplyEdit(Self, TLSPApplyWorkspaceEditParams(params),
            TLSPApplyWorkspaceEditResponse(rparams), errorCode, errorMessage);
    ...
    lspWorkspaceFolders:
      begin
        ...
        if Assigned(FOnWorkspaceFolders) then
          FOnWorkspaceFolders(Self, LWorkspaceFolders, bValue, bValue2,
            errorCode, errorMessage);
        ...
        if (resultType = lsprString) and (Length(LWorkspaceFolders) > 0) then
          LStr := TJSON.Stringify < TArray < TLSPWorkspaceFolder >>
            (LWorkspaceFolders);
    ...
    lspWorkspaceSymbol:
      begin
        // Create result object from Json string and check for errors
        LWorkspaceSymbols := JsonWorkspaceSymbolResultToObject(LJson, errorCode,
          errorMessage);
    ...
    lspWorkspaceWillCreateFiles:
      begin
        // Create result object from Json string and check for errors
        LStr := 'result';
        params := JsonWorkspaceApplyEditParamsToObject(LJson, LStr, errorCode,
          errorMessage);
        ...
        begin
          if Assigned(params) then
            FOnWorkspaceWillCreateFiles(Self,
              TLSPWorkspaceEdit(TLSPApplyWorkspaceEditParams(params).edit))
          else
    ...
    lspWorkspaceWillDeleteFiles:
      begin
        ...
        begin
          if Assigned(params) then
            FOnWorkspaceWillDeleteFiles(Self,
              TLSPWorkspaceEdit(TLSPApplyWorkspaceEditParams(params).edit))
          else
    ...
    lspWorkspaceWillRenameFiles:
      begin
        ...
        begin
          if Assigned(params) then
            FOnWorkspaceWillRenameFiles(Self,
              TLSPWorkspaceEdit(TLSPApplyWorkspaceEditParams(params).edit))
          else
    ...
    lspWillSaveWaitUntilTextDocument:
      begin
        // Create result object from Json string and check for errors
        LTextEditArray := JsonWillSaveWaitUntilResponseToObject(LJson,
          errorCode, errorMessage);
...
procedure TLSPClient.OnReadFromServer(Sender: TObject;
  const AJson: ISuperObject; const APlainText: string);
begin
  FResponseTimer.Enabled := False;
...
procedure TLSPClient.RegisterPartialResultToken(const lspKind: TLSPKind;
  const token: string);
var
  n: Integer;
begin
...
procedure TLSPClient.RunServer(const ACommandline, ADir: String;
  const AEnvList: string = ''; const AHost: string = '';
  const APort: Integer = 0; const AUseSocket: Boolean = False);
begin
...
begin
  ...
  if not Assigned(ServerCapabilities.textDocumentSync) then
    Exit;
...
function TLSPClient.IncludeText(const lspKind: TLSPKind; const filename: string;
  const includeDefault: Boolean): Boolean;
begin
  ...
  case lspKind of
    lspDidSaveTextDocument:
      begin
        if Assigned(ServerCapabilities) and
...
function TLSPClient.IsRequestSupported(const lspKind: TLSPKind;
  const ext: string = '*'): Boolean;
var
  LNotebookSelector: TLSPNoteBookSelector;
begin
  Result := False;
  if not Assigned(ServerCapabilities) then
    Exit;
  ...
  case lspKind of
    ...
    lspDidOpenNotebookDocument, lspDidCloseNotebookDocument,
      lspDidChangeNotebookDocument, lspDidSaveNotebookDocument:
      begin
        Result := Assigned(ServerCapabilities) and
        ...
        begin
          if Length(ServerCapabilities.notebookDocumentSync.notebookSelector) > 0
          then
          begin
            LNotebookSelector := ServerCapabilities.notebookDocumentSync.
              notebookSelector[0];
            Result := (LNotebookSelector.notebook <> '') or
              Assigned(LNotebookSelector.notebookFilter);
          end;
        end;
      end;
    lspWorkspaceSymbol:
    ...
    lspDocumentLinkResolve:
      begin
        Result := Assigned(ServerCapabilities.documentLinkProvider) and
    ...
    lspWorkspaceDiagnostic:
      begin
        Result := Assigned(ServerCapabilities.diagnosticProvider) and
          ServerCapabilities.diagnosticProvider.workspaceDiagnostics;
      end;
    lspRename:
      begin
    ...
    lspPrepareRename:
      begin
        Result := Assigned(ServerCapabilities.renameProvider) and
    ...
    lspPrepareCallHierarchy, lspCallHierarchyIncommingCalls,
      lspCallHierarchyOutgoingCalls:
      begin
        Result := Assigned(ServerCapabilities.callHierarchyProvider);
      end;
    lspPrepareTypeHierarchy, lspTypeHierarchySupertypes,
      lspTypeHierarchySubtypes:
      begin
    ...
    lspSemanticTokensFull:
      begin
        Result := Assigned(ServerCapabilities.semanticTokensProvider) and
          ServerCapabilities.semanticTokensProvider.full;
      end;
    lspSemanticTokensFullDelta:
      begin
        Result := Assigned(ServerCapabilities.semanticTokensProvider) and
          ServerCapabilities.semanticTokensProvider.full and
    ...
    lspInlayHint, lspInlayHintRefresh:
      begin
        Result := Assigned(ServerCapabilities.inlayHintProvider);
      end;
    lspInlayHintResolve:
      begin
        Result := Assigned(ServerCapabilities.inlayHintProvider) and
...
procedure TLSPClient.SendExecuteCommandRequest(const command: string;
  const argumentsJSON: string = '');
var
...
procedure TLSPClient.SendProgressNotification(token: string;
  const value: TLSPWorkDoneProgressValue);
var
...
procedure TLSPClient.SendRequest(const lspKind: TLSPKind;
  const method: string = ''; const params: TLSPBaseParams = nil;
  const paramJSON: string = '');
var
  msg: TLSPMessage;
...
begin
  ...
  case lspKind of
    lspInitialize:
      begin
        ...
        TLSPInitializeParams(LParams).capabilities :=
          TLSPClientCapabilities.Create;
  ...
  if Assigned(LParams) and not Assigned(params) then
    LParams.Free;
end;

procedure TLSPClient.SendResponse(const id: Integer; const method: string = '';
  const params: TLSPBaseParams = nil; const errors: TLSPBaseParams = nil;
  resultType: TLSPResultType = lsprObject; resultString: string = '');
var
  msg: TLSPMessage;
